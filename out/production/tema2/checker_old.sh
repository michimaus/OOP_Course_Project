...
RESOURCES_DIRECTORY="$CURRENT_DIRECTORY/checker_old/resources"
GOOD_TESTS=0
...
function checkStyle
{
	java -jar checker_old/checkstyle/checkstyle-7.3-all.jar -c checker_old/checkstyle/poo_checks.xml *  > checkstyle.txt
